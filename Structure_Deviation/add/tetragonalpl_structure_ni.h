...
#ifndef TETRAGONALPL_STRUCTURE_NI_H_
#define TETRAGONALPL_STRUCTURE_NI_H_
...
class tetraplStructNi{
	...
	static tetraplMetalicStructure* _tetrapl_struct_standard_ni;
	tetraplMetalicStructure* _tetrapl_struct_comparable_ni;
...
public:
	tetraplStructNi(){}
	tetraplStructNi(metal_binding_site, bool, string);
	tetraplMetalicStructure* form_tetrapl_site(int);
	static void gen_summary_report_tetrapl_ni(int);
};

#endif /* TRIGONALPL_STRUCTURE_NI_H_ */
