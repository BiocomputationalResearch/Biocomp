#ifndef TETRA_STRUCTURE_NI_H_
#define TETRA_STRUCTURE_NI_H_
...
class tetraStructNi{
	...
	static tetraMetalicStructure* _tetra_struct_standard_ni;
	tetraMetalicStructure* _tetra_struct_comparable_ni;
...
public:
	tetraStructNi(){}
	tetraStructNi(metal_binding_site, bool, string);
	tetraMetalicStructure* form_tetra_site(int);
	static void gen_summary_report_tetra_ni(int);
};

#endif /* TETRA_STRUCTURE_NI_H_ */
