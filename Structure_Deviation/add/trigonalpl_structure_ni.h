...
#ifndef TRIGONALPL_STRUCTURE_NI_H_
#define TRIGONALPL_STRUCTURE_NI_H_
...
class triplStructNi{
	...
	static triplMetalicStructure* _tripl_struct_standard_ni;
	triplMetalicStructure* _tripl_struct_comparable_ni;
...
public:
	triplStructNi(){}
	triplStructNi(metal_binding_site, bool, string);
	triplMetalicStructure* form_tripl_site(int);
	static void gen_summary_report_tripl_ni(int);
};
