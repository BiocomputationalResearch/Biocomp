#ifndef TRIGONALBIPYR_STRUCTURE_CD_H_
#define TRIGONALBIPYR_STRUCTURE_CD_H_
...
class tribipyrStructCd{
	...
	static tribipyrMetalicStructure* _tribipyr_struct_standard_cd;
	tribipyrMetalicStructure* _tribipyr_struct_comparable_cd;
...
public:
	tribipyrStructCd(){}
	tribipyrStructCd(metal_binding_site, bool, string);
	tribipyrMetalicStructure* form_tribipyr_site(int);
	static void gen_summary_report_tribipyr_cd(int);
};

#endif /* TRIGONALBIPYR_STRUCTURE_CD_H_ */
