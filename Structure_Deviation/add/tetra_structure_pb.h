#ifndef TETRA_STRUCTURE_PB_H_
#define TETRA_STRUCTURE_PB_H_
...
class tetraStructPb{
	...
	static tetraMetalicStructure* _tetra_struct_standard_pb;
	tetraMetalicStructure* _tetra_struct_comparable_pb;
...
public:
	tetraStructPb(){}
	tetraStructPb(metal_binding_site, bool, string);
	tetraMetalicStructure* form_tetra_site(int);
	static void gen_summary_report_tetra_pb(int);
};

#endif /* TETRA_STRUCTURE_PB_H_ */
