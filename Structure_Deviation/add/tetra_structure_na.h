#ifndef TETRA_STRUCTURE_NA_H_
#define TETRA_STRUCTURE_NA_H_
...
class tetraStructNa{
	...
	static tetraMetalicStructure* _tetra_struct_standard_na;
	tetraMetalicStructure* _tetra_struct_comparable_na;
...
public:
	tetraStructNa(){}
	tetraStructNa(metal_binding_site, bool, string);
	tetraMetalicStructure* form_tetra_site(int);
	static void gen_summary_report_tetra_na(int);
};

#endif /* TETRA_STRUCTURE_NA_H_ */
