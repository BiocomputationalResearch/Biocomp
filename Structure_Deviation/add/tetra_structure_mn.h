#ifndef TETRA_STRUCTURE_MN_H_
#define TETRA_STRUCTURE_MN_H_
...
class tetraStructMn{
	...
	static tetraMetalicStructure* _tetra_struct_standard_mn;
	tetraMetalicStructure* _tetra_struct_comparable_mn;
...
public:
	tetraStructMn(){}
	tetraStructMn(metal_binding_site, bool, string);
	tetraMetalicStructure* form_tetra_site(int);
	static void gen_summary_report_tetra_mn(int);
};

#endif /* TETRA_STRUCTURE_MN_H_ */
