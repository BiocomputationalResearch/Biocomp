...
#ifndef TRIGONALPL_STRUCTURE_MN_H_
#define TRIGONALPL_STRUCTURE_MN_H_
...
class triplStructMn{
	...
	static triplMetalicStructure* _tripl_struct_standard_mn;
	triplMetalicStructure* _tripl_struct_comparable_mn;
...
public:
	triplStructMn(){}
	triplStructMn(metal_binding_site, bool, string);
	triplMetalicStructure* form_tripl_site(int);
	static void gen_summary_report_tripl_mn(int);
};

#endif /* TRIGONALPL_STRUCTURE_ZN_H_ */
