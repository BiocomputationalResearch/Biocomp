#ifndef TRIGONALBIPYR_STRUCTURE_CO_H_
#define TRIGONALBIPYR_STRUCTURE_CO_H_
...
class tribipyrStructCo{
	...
	static tribipyrMetalicStructure* _tribipyr_struct_standard_co;
	tribipyrMetalicStructure* _tribipyr_struct_comparable_co;
...
public:
	tribipyrStructCo(){}
	tribipyrStructCo(metal_binding_site, bool, string);
	tribipyrMetalicStructure* form_tribipyr_site(int);
	static void gen_summary_report_tribipyr_co(int);
};

#endif /* TRIGONALBIPYR_STRUCTURE_CO_H_ */
