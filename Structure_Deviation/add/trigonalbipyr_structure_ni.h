#ifndef TRIGONALBIPYR_STRUCTURE_NI_H_
#define TRIGONALBIPYR_STRUCTURE_NI_H_
...
class tribipyrStructNi{
	...
	static tribipyrMetalicStructure* _tribipyr_struct_standard_ni;
	tribipyrMetalicStructure* _tribipyr_struct_comparable_ni;
...
public:
	tribipyrStructNi(){}
	tribipyrStructNi(metal_binding_site, bool, string);
	tribipyrMetalicStructure* form_tribipyr_site(int);
	static void gen_summary_report_tribipyr_ni(int);
};

#endif /* TRIGONALBIPYR_STRUCTURE_NI_H_ */
