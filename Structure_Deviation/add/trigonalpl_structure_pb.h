...
#ifndef TRIGONALPL_STRUCTURE_PB_H_
#define TRIGONALPL_STRUCTURE_PB_H_
...
class triplStructPb{
	...
	static triplMetalicStructure* _tripl_struct_standard_pb;
	triplMetalicStructure* _tripl_struct_comparable_pb;
...
public:
	triplStructPb(){}
	triplStructPb(metal_binding_site, bool, string);
	triplMetalicStructure* form_tripl_site(int);
	static void gen_summary_report_tripl_pb(int);
};
