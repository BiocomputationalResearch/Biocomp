#ifndef OCTA_STRUCTURE_CA_H_
#define OCTA_STRUCTURE_CA_H_
...
class octaStructCa{
	...
	static octaMetalicStructure* _octa_struct_standard_ca;
	octaMetalicStructure* _octa_struct_comparable_ca;
...
public:
	octaStructCa(){}
	octaStructCa(metal_binding_site, bool, string);
	octaMetalicStructure* form_octa_site(int);
	static void gen_summary_report_octa_ca(int);
};

#endif /* OCTA_STRUCTURE_CA_H_ */
