...
#ifndef TRIGONALPL_STRUCTURE_CD_H_
#define TRIGONALPL_STRUCTURE_CD_H_
...
class triplStructCd{
	...
	static triplMetalicStructure* _tripl_struct_standard_cd;
	triplMetalicStructure* _tripl_struct_comparable_cd;
...
public:
	triplStructCd(){}
	triplStructCd(metal_binding_site, bool, string);
	triplMetalicStructure* form_tripl_site(int);
	static void gen_summary_report_tripl_cd(int);
};
