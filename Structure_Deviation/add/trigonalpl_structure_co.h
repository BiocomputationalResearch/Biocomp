...
#ifndef TRIGONALPL_STRUCTURE_CO_H_
#define TRIGONALPL_STRUCTURE_CO_H_
...
class triplStructCo{
	...
	static triplMetalicStructure* _tripl_struct_standard_co;
	triplMetalicStructure* _tripl_struct_comparable_co;
...
public:
	triplStructCo(){}
	triplStructCo(metal_binding_site, bool, string);
	triplMetalicStructure* form_tripl_site(int);
	static void gen_summary_report_tripl_co(int);
};

#endif /* TRIGONALPL_STRUCTURE_CO_H_ */
