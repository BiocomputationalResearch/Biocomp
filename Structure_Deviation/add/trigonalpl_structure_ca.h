...
#ifndef TRIGONALPL_STRUCTURE_CA_H_
#define TRIGONALPL_STRUCTURE_CA_H_
...
class triplStructCa{
	...
	static triplMetalicStructure* _tripl_struct_standard_ca;
	triplMetalicStructure* _tripl_struct_comparable_ca;
...
public:
	triplStructCa(){}
	triplStructCa(metal_binding_site, bool, string);
	triplMetalicStructure* form_tripl_site(int);
	static void gen_summary_report_tripl_ca(int);
};

#endif /* TRIGONALPL_STRUCTURE_CA_H_ */
