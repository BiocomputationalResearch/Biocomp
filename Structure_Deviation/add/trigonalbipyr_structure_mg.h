#ifndef TRIGONALBIPYR_STRUCTURE_MG_H_
#define TRIGONALBIPYR_STRUCTURE_MG_H_
...
class tribipyrStructMg{
	...
	static tribipyrMetalicStructure* _tribipyr_struct_standard_mg;
	tribipyrMetalicStructure* _tribipyr_struct_comparable_mg;
...
public:
	tribipyrStructMg(){}
	tribipyrStructMg(metal_binding_site, bool, string);
	tribipyrMetalicStructure* form_tribipyr_site(int);
	static void gen_summary_report_tribipyr_mg(int);
};

#endif /* TRIGONALBIPYR_STRUCTURE_MG_H_ */
