#ifndef TETRA_STRUCTURE_FE_H_
#define TETRA_STRUCTURE_FE_H_
...
class tetraStructFe{
	...
	static tetraMetalicStructure* _tetra_struct_standard_fe;
	tetraMetalicStructure* _tetra_struct_comparable_fe;
...
public:
	tetraStructFe(){}
	tetraStructFe(metal_binding_site, bool, string);
	tetraMetalicStructure* form_tetra_site(int);
	static void gen_summary_report_tetra_fe(int);
};

#endif /* TETRA_STRUCTURE_FE_H_ */
