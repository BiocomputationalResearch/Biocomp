#ifndef TRIGONALBIPYR_STRUCTURE_MN_H_
#define TRIGONALBIPYR_STRUCTURE_MN_H_
...
class tribipyrStructMn{
	...
	static tribipyrMetalicStructure* _tribipyr_struct_standard_mn;
	tribipyrMetalicStructure* _tribipyr_struct_comparable_mn;
...
public:
	tribipyrStructMn(){}
	tribipyrStructMn(metal_binding_site, bool, string);
	tribipyrMetalicStructure* form_tribipyr_site(int);
	static void gen_summary_report_tribipyr_mn(int);
};

#endif /* TRIGONALBIPYR_STRUCTURE_MN_H_ */
