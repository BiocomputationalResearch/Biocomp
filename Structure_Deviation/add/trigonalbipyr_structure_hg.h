#ifndef TRIGONALBIPYR_STRUCTURE_HG_H_
#define TRIGONALBIPYR_STRUCTURE_HG_H_
...
class tribipyrStructHg{
	...
	static tribipyrMetalicStructure* _tribipyr_struct_standard_hg;
	tribipyrMetalicStructure* _tribipyr_struct_comparable_hg;
...
public:
	tribipyrStructHg(){}
	tribipyrStructHg(metal_binding_site, bool, string);
	tribipyrMetalicStructure* form_tribipyr_site(int);
	static void gen_summary_report_tribipyr_hg(int);
};

#endif /* TRIGONALBIPYR_STRUCTURE_HG_H_ */
