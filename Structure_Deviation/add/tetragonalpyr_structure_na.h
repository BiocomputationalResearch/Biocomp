#ifndef TETRAGONALPYR_STRUCTURE_NA_H_
#define TETRAGONALPYR_STRUCTURE_NA_H_
...
class tetrapyrStructNa{
	...
	static tetrapyrMetalicStructure* _tetrapyr_struct_standard_na;
	tetrapyrMetalicStructure* _tetrapyr_struct_comparable_na;
	string _site_type_comparable;
	static double _avg_dist_devt_from_cc;
	static double _avg_devt_dist_vert_vert[8];	//Average deviation of edges of two tetragonal pyramidal sites
...
public:
	tetrapyrStructNa(){}
	tetrapyrStructNa(metal_binding_site, bool, string);
	tetrapyrMetalicStructure* form_tetrapyr_site(int);
	static void gen_summary_report_tetrapyr_na(int);
};

#endif /* TETRAGONALPYR_STRUCTURE_NA_H_ */
