#ifndef OCTA_STRUCTURE_FE_H_
#define OCTA_STRUCTURE_FE_H_
...
class octaStructFe{
	...
	static octaMetalicStructure* _octa_struct_standard_fe;
	octaMetalicStructure* _octa_struct_comparable_fe;
...
public:
	octaStructFe(){}
	octaStructFe(metal_binding_site, bool, string);
	octaMetalicStructure* form_octa_site(int);
	static void gen_summary_report_octa_fe(int);
};

#endif /* OCTA_STRUCTURE_FE_H_ */
