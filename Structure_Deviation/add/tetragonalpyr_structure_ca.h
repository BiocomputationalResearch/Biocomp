#ifndef TETRAGOCALPYR_STRUCTURE_CA_H_
#define TETRAGOCALPYR_STRUCTURE_CA_H_

#include <assert.h>
#include "coordinationsite.h"
//#include "trigocal_bipyramidal.h"
#include "tetragonal_pyramidal.h"
#include "stdio.h"

class tetrapyrStructCa{
	string _accn;
	...
	static tetrapyrMetalicStructure* _tetrapyr_struct_standard_ca;
	tetrapyrMetalicStructure* _tetrapyr_struct_comparable_ca;
	string _site_type_comparable;
	static double _avg_dist_devt_from_cc;
	static double _avg_devt_dist_vert_vert[8];	//Average deviation of edges of two tetragocal pyramidal sites
...
public:
	tetrapyrStructCa(){}
	tetrapyrStructCa(metal_binding_site, bool, string);
	tetrapyrMetalicStructure* form_tetrapyr_site(int);
	static void gen_summary_report_tetrapyr_ca(int);
};

#endif /* TETRAGOCALPYR_STRUCTURE_CA_H_ */
