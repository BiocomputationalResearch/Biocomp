#ifndef TETRA_STRUCTURE_ZN_H_
#define TETRA_STRUCTURE_ZN_H_
...
class tetraStructZn{
	...
	static tetraMetalicStructure* _tetra_struct_standard_zn;
	tetraMetalicStructure* _tetra_struct_comparable_zn;
...
public:
	tetraStructZn(){}
	tetraStructZn(metal_binding_site, bool, string);
	tetraMetalicStructure* form_tetra_site(int);
	static void gen_summary_report_tetra_zn(int);
};

#endif /* TETRA_STRUCTURE_ZN_H_ */
