#ifndef TETRA_STRUCTURE_CU_H_
#define TETRA_STRUCTURE_CU_H_
...
class tetraStructCu{
	...
	static tetraMetalicStructure* _tetra_struct_standard_cu;
	tetraMetalicStructure* _tetra_struct_comparable_cu;
...
public:
	tetraStructCu(){}
	tetraStructCu(metal_binding_site, bool, string);
	tetraMetalicStructure* form_tetra_site(int);
	static void gen_summary_report_tetra_cu(int);
};

#endif /* TETRA_STRUCTURE_CU_H_ */
