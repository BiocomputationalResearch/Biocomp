...
#ifndef TRIGONALPL_STRUCTURE_CU_H_
#define TRIGONALPL_STRUCTURE_CU_H_
...
class triplStructCu{
	...
	static triplMetalicStructure* _tripl_struct_standard_cu;
	triplMetalicStructure* _tripl_struct_comparable_cu;
...
public:
	triplStructCu(){}
	triplStructCu(metal_binding_site, bool, string);
	triplMetalicStructure* form_tripl_site(int);
	static void gen_summary_report_tripl_cu(int);
};

#endif /* TRIGONALPL_STRUCTURE_CU_H_ */
