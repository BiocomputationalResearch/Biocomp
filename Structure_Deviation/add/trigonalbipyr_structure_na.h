#ifndef TRIGONALBIPYR_STRUCTURE_NA_H_
#define TRIGONALBIPYR_STRUCTURE_NA_H_
...
class tribipyrStructNa{
	...
	static tribipyrMetalicStructure* _tribipyr_struct_standard_na;
	tribipyrMetalicStructure* _tribipyr_struct_comparable_na;
...
public:
	tribipyrStructNa(){}
	tribipyrStructNa(metal_binding_site, bool, string);
	tribipyrMetalicStructure* form_tribipyr_site(int);
	static void gen_summary_report_tribipyr_na(int);
};

#endif /* TRIGONALBIPYR_STRUCTURE_NA_H_ */
