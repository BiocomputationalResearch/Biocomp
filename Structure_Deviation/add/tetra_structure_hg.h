#ifndef TETRA_STRUCTURE_HG_H_
#define TETRA_STRUCTURE_HG_H_
...
class tetraStructHg{
	...
	static tetraMetalicStructure* _tetra_struct_standard_hg;
	tetraMetalicStructure* _tetra_struct_comparable_hg;
...
public:
	tetraStructHg(){}
	tetraStructHg(metal_binding_site, bool, string);
	tetraMetalicStructure* form_tetra_site(int);
	static void gen_summary_report_tetra_hg(int);
};

#endif /* TETRA_STRUCTURE_HG_H_ */
