...
#ifndef TRIGONALPL_STRUCTURE_AS_H_
#define TRIGONALPL_STRUCTURE_AS_H_
...
class triplStructAs{
	...
	static triplMetalicStructure* _tripl_struct_standard_as;
	triplMetalicStructure* _tripl_struct_comparable_as;
...
public:
	triplStructAs(){}
	triplStructAs(metal_binding_site, bool, string);
	triplMetalicStructure* form_tripl_site(int);
	static void gen_summary_report_tripl_as(int);
};

#endif /* TRIGONALPL_STRUCTURE_AS_H_ */
