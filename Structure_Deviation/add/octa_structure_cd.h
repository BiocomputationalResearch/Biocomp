#ifndef OCTA_STRUCTURE_CD_H_
#define OCTA_STRUCTURE_CD_H_
...
class octaStructCd{
	...
	static octaMetalicStructure* _octa_struct_standard_cd;
	octaMetalicStructure* _octa_struct_comparable_cd;
...
public:
	octaStructCd(){}
	octaStructCd(metal_binding_site, bool, string);
	octaMetalicStructure* form_octa_site(int);
	static void gen_summary_report_octa_cd(int);
};

#endif /* OCTA_STRUCTURE_CD_H_ */
