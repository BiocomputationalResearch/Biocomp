#ifndef TETRA_STRUCTURE_CS_H_
#define TETRA_STRUCTURE_CS_H_
...
class tetraStructCs{
	...
	static tetraMetalicStructure* _tetra_struct_standard_cs;
	tetraMetalicStructure* _tetra_struct_comparable_cs;
...
public:
	tetraStructCs(){}
	tetraStructCs(metal_binding_site, bool, string);
	tetraMetalicStructure* form_tetra_site(int);
	static void gen_summary_report_tetra_cs(int);
};

#endif /* TETRA_STRUCTURE_CS_H_ */
