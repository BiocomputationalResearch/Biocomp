...
#ifndef TRIGONALPL_STRUCTURE_ZN_H_
#define TRIGONALPL_STRUCTURE_ZN_H_
...
class triplStructZn{
	...
	static triplMetalicStructure* _tripl_struct_standard_zn;
	triplMetalicStructure* _tripl_struct_comparable_zn;
...
public:
	triplStructZn(){}
	triplStructZn(metal_binding_site, bool, string);
	triplMetalicStructure* form_tripl_site(int);
	static void gen_summary_report_tripl_zn(int);
};
