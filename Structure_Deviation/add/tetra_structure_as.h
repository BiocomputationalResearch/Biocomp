#ifndef TETRA_STRUCTURE_AS_H_
#define TETRA_STRUCTURE_AS_H_
...
class tetraStructAs{
	...
	static tetraMetalicStructure* _tetra_struct_standard_as;
	tetraMetalicStructure* _tetra_struct_comparable_as;
...
public:
	tetraStructAs(){}
	tetraStructAs(metal_binding_site, bool, string);
	tetraMetalicStructure* form_tetra_site(int);
	static void gen_summary_report_tetra_as(int);
};

#endif /* TETRA_STRUCTURE_AS_H_ */
