#ifndef TETRA_STRUCTURE_CD_H_
#define TETRA_STRUCTURE_CD_H_
...
class tetraStructCd{
	...
	static tetraMetalicStructure* _tetra_struct_standard_cd;
	tetraMetalicStructure* _tetra_struct_comparable_cd;
...
public:
	tetraStructCd(){}
	tetraStructCd(metal_binding_site, bool, string);
	tetraMetalicStructure* form_tetra_site(int);
	static void gen_summary_report_tetra_cd(int);
};

#endif /* TETRA_STRUCTURE_CD_H_ */
