#ifndef TETRA_STRUCTURE_MG_H_
#define TETRA_STRUCTURE_MG_H_
...
class tetraStructMg{
	...
	static tetraMetalicStructure* _tetra_struct_standard_mg;
	tetraMetalicStructure* _tetra_struct_comparable_mg;
...
public:
	tetraStructMg(){}
	tetraStructMg(metal_binding_site, bool, string);
	tetraMetalicStructure* form_tetra_site(int);
	static void gen_summary_report_tetra_mg(int);
};

#endif /* TETRA_STRUCTURE_MG_H_ */
