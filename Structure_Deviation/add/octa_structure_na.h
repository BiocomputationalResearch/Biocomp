#ifndef OCTA_STRUCTURE_NA_H_
#define OCTA_STRUCTURE_NA_H_
...
class octaStructNa{
	...
	static octaMetalicStructure* _octa_struct_standard_na;
	octaMetalicStructure* _octa_struct_comparable_na;
...
public:
	octaStructNa(){}
	octaStructNa(metal_binding_site, bool, string);
	octaMetalicStructure* form_octa_site(int);
	static void gen_summary_report_octa_na(int);
};

#endif /* OCTA_STRUCTURE_NA_H_ */
