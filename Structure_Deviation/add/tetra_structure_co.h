#ifndef TETRA_STRUCTURE_CO_H_
#define TETRA_STRUCTURE_CO_H_
...
class tetraStructCo{
	...
	static tetraMetalicStructure* _tetra_struct_standard_co;
	tetraMetalicStructure* _tetra_struct_comparable_co;
...
public:
	tetraStructCo(){}
	tetraStructCo(metal_binding_site, bool, string);
	tetraMetalicStructure* form_tetra_site(int);
	static void gen_summary_report_tetra_co(int);
};

#endif /* TETRA_STRUCTURE_CO_H_ */
