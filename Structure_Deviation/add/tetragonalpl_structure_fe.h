...
#ifndef TETRAGONALPL_STRUCTURE_FE_H_
#define TETRAGONALPL_STRUCTURE_FE_H_
...
class tetraplStructFe{
	...
	static tetraplMetalicStructure* _tetrapl_struct_standard_fe;
	tetraplMetalicStructure* _tetrapl_struct_comparable_fe;
...
public:
	tetraplStructFe(){}
	tetraplStructFe(metal_binding_site, bool, string);
	tetraplMetalicStructure* form_tetrapl_site(int);
	static void gen_summary_report_tetrapl_fe(int);
};
