#ifndef OCTA_STRUCTURE_MN_H_
#define OCTA_STRUCTURE_MN_H_
...
class octaStructMn{
	...
	static octaMetalicStructure* _octa_struct_standard_mn;
	octaMetalicStructure* _octa_struct_comparable_mn;
...
public:
	octaStructMn(){}
	octaStructMn(metal_binding_site, bool, string);
	octaMetalicStructure* form_octa_site(int);
	static void gen_summary_report_octa_mn(int);
};

#endif /* OCTA_STRUCTURE_MN_H_ */
