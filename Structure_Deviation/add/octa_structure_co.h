#ifndef OCTA_STRUCTURE_CO_H_
#define OCTA_STRUCTURE_CO_H_
...
class octaStructCo{
	...
	static octaMetalicStructure* _octa_struct_standard_co;
	octaMetalicStructure* _octa_struct_comparable_co;
...
public:
	octaStructCo(){}
	octaStructCo(metal_binding_site, bool, string);
	octaMetalicStructure* form_octa_site(int);
	static void gen_summary_report_octa_co(int);
};

#endif /* OCTA_STRUCTURE_CO_H_ */
