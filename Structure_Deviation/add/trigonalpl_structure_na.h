...
#ifndef TRIGONALPL_STRUCTURE_NA_H_
#define TRIGONALPL_STRUCTURE_NA_H_
...
class triplStructNa{
	...
	static triplMetalicStructure* _tripl_struct_standard_na;
	triplMetalicStructure* _tripl_struct_comparable_na;
...
public:
	triplStructNa(){}
	triplStructNa(metal_binding_site, bool, string);
	triplMetalicStructure* form_tripl_site(int);
	static void gen_summary_report_tripl_na(int);
};

#endif /* TRIGONALPL_STRUCTURE_NA_H_ */
