#ifndef TRIGONALBIPYR_STRUCTURE_FE_H_
#define TRIGONALBIPYR_STRUCTURE_FE_H_
...
class tribipyrStructFe{
	...
	static tribipyrMetalicStructure* _tribipyr_struct_standard_fe;
	tribipyrMetalicStructure* _tribipyr_struct_comparable_fe;
...
public:
	tribipyrStructFe(){}
	tribipyrStructFe(metal_binding_site, bool, string);
	tribipyrMetalicStructure* form_tribipyr_site(int);
	static void gen_summary_report_tribipyr_fe(int);
};

#endif /* TRIGONALBIPYR_STRUCTURE_FE_H_ */
