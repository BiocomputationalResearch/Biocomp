#ifndef TRIGONALBIPYR_STRUCTURE_ZN_H_
#define TRIGONALBIPYR_STRUCTURE_ZN_H_
...
class tribipyrStructZn{
	...
	static tribipyrMetalicStructure* _tribipyr_struct_standard_zn;
	tribipyrMetalicStructure* _tribipyr_struct_comparable_zn;
...
public:
	tribipyrStructZn(){}
	tribipyrStructZn(metal_binding_site, bool, string);
	tribipyrMetalicStructure* form_tribipyr_site(int);
	static void gen_summary_report_tribipyr_zn(int);
};

#endif /* TRIGONALBIPYR_STRUCTURE_ZN_H_ */
