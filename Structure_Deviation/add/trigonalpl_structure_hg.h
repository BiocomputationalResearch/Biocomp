...
#ifndef TRIGONALPL_STRUCTURE_HG_H_
#define TRIGONALPL_STRUCTURE_HG_H_
...
class triplStructHg{
	...
	static triplMetalicStructure* _tripl_struct_standard_hg;
	triplMetalicStructure* _tripl_struct_comparable_hg;
...
public:
	triplStructHg(){}
	triplStructHg(metal_binding_site, bool, string);
	triplMetalicStructure* form_tripl_site(int);
	static void gen_summary_report_tripl_hg(int);
};

#endif /* TRIGONALPL_STRUCTURE_HG_H_ */
