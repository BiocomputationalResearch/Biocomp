#ifndef OCTA_STRUCTURE_MG_H_
#define OCTA_STRUCTURE_MG_H_
...
class octaStructMg{
	...
	static octaMetalicStructure* _octa_struct_standard_mg;
	octaMetalicStructure* _octa_struct_comparable_mg;
...
public:
	octaStructMg(){}
	octaStructMg(metal_binding_site, bool, string);
	octaMetalicStructure* form_octa_site(int);
	static void gen_summary_report_octa_mg(int);
};

#endif /* OCTA_STRUCTURE_MG_H_ */
