...
#ifndef TRIGONALPL_STRUCTURE_MG_H_
#define TRIGONALPL_STRUCTURE_MG_H_
...
class triplStructMg{
	...
	static triplMetalicStructure* _tripl_struct_standard_mg;
	triplMetalicStructure* _tripl_struct_comparable_mg;
...
public:
	triplStructMg(){}
	triplStructMg(metal_binding_site, bool, string);
	triplMetalicStructure* form_tripl_site(int);
	static void gen_summary_report_tripl_mg(int);
};
