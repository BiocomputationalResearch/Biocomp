...
#ifndef TRIGONALPL_STRUCTURE_K_H_
#define TRIGONALPL_STRUCTURE_K_H_
...
class triplStructK{
	...
	static triplMetalicStructure* _tripl_struct_standard_k;
	triplMetalicStructure* _tripl_struct_comparable_k;
...
public:
	triplStructK(){}
	triplStructK(metal_binding_site, bool, string);
	triplMetalicStructure* form_tripl_site(int);
	static void gen_summary_report_tripl_k(int);
};

#endif /* TRIGONALPL_STRUCTURE_K_H_ */
