...
#ifndef TETRAGONALPL_STRUCTURE_MG_H_
#define TETRAGONALPL_STRUCTURE_MG_H_
...
class tetraplStructMg{
	...
	static tetraplMetalicStructure* _tetrapl_struct_standard_mg;
	tetraplMetalicStructure* _tetrapl_struct_comparable_mg;
...
public:
	tetraplStructMg(){}
	tetraplStructMg(metal_binding_site, bool, string);
	tetraplMetalicStructure* form_tetrapl_site(int);
	static void gen_summary_report_tetrapl_mg(int);
};

#endif /* TRIGONALPL_STRUCTURE_MG_H_ */
