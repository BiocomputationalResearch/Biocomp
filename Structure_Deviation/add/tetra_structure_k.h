#ifndef TETRA_STRUCTURE_K_H_
#define TETRA_STRUCTURE_K_H_
...
class tetraStructK{
	...
	static tetraMetalicStructure* _tetra_struct_standard_k;
	tetraMetalicStructure* _tetra_struct_comparable_k;
...
public:
	tetraStructK(){}
	tetraStructK(metal_binding_site, bool, string);
	tetraMetalicStructure* form_tetra_site(int);
	static void gen_summary_report_tetra_k(int);
};

#endif /* TETRA_STRUCTURE_K_H_ */
