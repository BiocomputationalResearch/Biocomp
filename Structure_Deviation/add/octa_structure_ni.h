#ifndef OCTA_STRUCTURE_NI_H_
#define OCTA_STRUCTURE_NI_H_
...
class octaStructNi{
	...
	static octaMetalicStructure* _octa_struct_standard_ni;
	octaMetalicStructure* _octa_struct_comparable_ni;
...
public:
	octaStructNi(){}
	octaStructNi(metal_binding_site, bool, string);
	octaMetalicStructure* form_octa_site(int);
	static void gen_summary_report_octa_ni(int);
};

#endif /* OCTA_STRUCTURE_NI_H_ */
